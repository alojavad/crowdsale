...
contract ReflectToken {
    ...
    function _transfer(address from, address to, uint256 value) internal {
        ...
        require(balanceOf[from] >= value + buyTax + sellTax + reflectionAmount , "Insufficient balance, can not pa tax and reflection");
        balanceOf[address(this)] += reflectionAmount;
        balanceOf[from] -= (value + buyTax + sellTax + reflectionAmount);
